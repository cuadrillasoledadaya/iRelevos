...
export const relevosTableCSS: string = `width:100%;border-collapse:collapse;margin-bottom:10px;`;
 ...
 */
export function roleHeaderHTML(
	emoji: string,
	label: string,
	bg?: string,
): string {
 ...
 */
export function relevosPageTitleHTML(
...
export function tableWrapperHTML(
	content: string,
	pageBreakAfter = false,
): string {
	const extra = pageBreakAfter
		? " page-break-after:always; margin-bottom: 40px;"
		: "margin-bottom:30px;";
