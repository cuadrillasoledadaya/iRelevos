...
import { uiStore, projectStore, bancoStore, trabajaderaStore } from "@/stores";
...
export default function BancoSheet() {
	...
	const usarBanco = trabajaderaStore.getState().usarBanco;
				...
				<div className="bs-body">
					...
					<div className="perfil-nuevo">
						<input
							...
							style={{ height: "38px" }}
						/>
						<button className="btn btn-out btn-sm" onClick={handleAdd}>
							+ Añadir
						</button>
					</div>
				</div>
